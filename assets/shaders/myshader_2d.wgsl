...
fn fragment(in: MeshVertexOutput) -> @location(0) vec4<f32> {
    ...
    // p = uv * TAU * 2.0 % TAU - 250.0;  // With SHOW_TILING
    p = uv * TAU % TAU - 250.0;    // Without SHOW_TILING
    ...
    // Tiling borders (choose this block based on whether SHOW_TILING is defined or not)
